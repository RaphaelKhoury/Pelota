...
class EventNotifier implements PipeCallback<String>
{
  ...
  protected String m_trueSymbol = "⊤";
  protected String m_falseSymbol = "⊥";
  ...
  public void setTrueSymbol(String s)
  {
	  m_trueSymbol = s;
  }
  
  public void setFalseSymbol(String s)
  {
	  m_falseSymbol = s;
  }
  ...
  public synchronized String formatVerdicts()
  {
    ...
    for (int i = 0; i < m_minfo.size(); i++)
    {
      ...
      if (v == Monitor.Verdict.INCONCLUSIVE)
        ...
        out.append(m_trueSymbol);
      else if (v == Monitor.Verdict.FALSE)
        out.append(m_falseSymbol);
