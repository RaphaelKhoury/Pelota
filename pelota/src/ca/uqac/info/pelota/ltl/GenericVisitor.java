...
public class GenericVisitor implements OperatorVisitor
{
  ...
  @Override
  public void visit(OperatorNotEquals o) //RK
  {
    StringBuffer right = m_pieces.pop();
    StringBuffer left = m_pieces.pop();
    StringBuffer out = new StringBuffer("").append(left).append(") ").append(OperatorNotEquals.SYMBOL).append(" (").append(right).append("");
    m_pieces.push(out);
  }
  
  @Override
  public void visit(OperatorR o) //RK
  {
    StringBuffer right = m_pieces.pop();
    StringBuffer left = m_pieces.pop();
    StringBuffer out = new StringBuffer("").append(left).append(") ").append(OperatorR.SYMBOL).append(" (").append(right).append("");
    m_pieces.push(out);
  }
