...
public abstract class Operator
{
  ...
  protected static Operator parseFromString(String s, Set<Atom> bound_variables) throws ParseException
  {
    ...
    else if (containsBinaryOperator(s))
    {
      ...
      else if (op.compareTo(OperatorNotEquals.SYMBOL) == 0)//RK
          bo = new OperatorNotEquals();
...
private static String trimComments(String s)
  ...
  {  //RK
    return   s.indexOf(OperatorR.SYMBOL) != -1 ||   s.indexOf(OperatorNotEquals.SYMBOL) != -1 ||  s.indexOf(OperatorAnd.SYMBOL) != -1 || s.indexOf(OperatorOr.SYMBOL) != -1 || s.indexOf(OperatorXor.SYMBOL) != -1 || s.indexOf(OperatorImplies.SYMBOL) != -1 || s.indexOf(OperatorEquals.SYMBOL) != -1 || s.indexOf(OperatorGreaterThan.SYMBOL) != -1 || s.indexOf(" " + OperatorU.SYMBOL + " ") != -1;
  }
    ...
    else
    {
      ...
      for (int i = 1; i < s.length(); i++)
      {
        ...
        if (c.compareTo("(") == 0 || c.compareTo(")") == 0 || 
            ...
            c.compareTo(OperatorEquals.SYMBOL) == 0 || c.compareTo(OperatorNotEquals.SYMBOL) == 0 ||
            c.compareTo(OperatorImplies.SYMBOL) == 0  ||   c.compareTo(OperatorR.SYMBOL) == 0)
    ...
    else
    {
      ...
      {  //RK
        ...
        if (c.compareTo("(") == 0 || c.compareTo(")") == 0 || 
            c.compareTo(OperatorAnd.SYMBOL) == 0  || c.compareTo(OperatorOr.SYMBOL) == 0 ||
            c.compareTo(OperatorXor.SYMBOL) == 0 || c.compareTo(OperatorGreaterThan.SYMBOL) == 0 ||
            c.compareTo(OperatorEquals.SYMBOL) == 0 || c.compareTo(OperatorNotEquals.SYMBOL) == 0 || c.compareTo(OperatorImplies.SYMBOL) == 0
            ||   c.compareTo(OperatorR.SYMBOL) == 0)
