...
public class XPathEvent extends Event
{
  ...
  public XPathEvent(String s) throws EventException
  {
    ...
    catch (ca.uqac.info.pelota.xml.Element.ParseException e)
    {
  ...
  @Override
  public List<Element> evaluate(SimpleXPathExpression query, Map<String,String> variables) throws EvaluationException
  {
